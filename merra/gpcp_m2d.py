...
def mk_ctl(sfile, year):
  ...
  #----
  sout = ""
  sout = sout + "DSET gpcp_1dd_v1.1_p1d.%y4%m2%d2.bn\n"
...
for year in range(iyear, eyear +1):
  ...
  sodir = "/media/disk2/data/GPCP1DD/data/1dd/%04d"%(year)
  mk_dir(sodir)
  #**************
  # make annal ctl file
  #--------------
  sctlfile = sodir + "/gpcp_1dd_v1.1_p1d.%04d.ctl"%(year)
  ...
  for mon in range(imon, emon+1):
    ...
    #*****************
    siname  = sidir + "/gpcp_1dd_v1.1_p1d.%04d%02d"%(year, mon)
    ...
    sheadfile = sodir + "/head.gpcp_1dd_v1.1_p1d.%04d%02d"%(year, mon)
    ...
    for day in range(1, calendar.monthrange(year, mon)[1]+1):
      ...
      # soname
      #------------
      soname = sodir + "/gpcp_1dd_v1.1_p1d.%04d%02d%02d.bn"%(year, mon, day)
      #************
      # make daily ctl file
      #------------
      sctlfile_daily = sodir + "/gpcp_1dd_v1.1_p1d.%04d%02d%02d.ctl"%(year, mon, day)
