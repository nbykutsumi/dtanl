...
if (len(sys.argv) >1):
  ...
  ny       = int(sys.argv[8])
  nz       = int(sys.argv[9])
  miss_dbl = float(sys.argv[10])
  miss_int = int(sys.argv[11])
  crad     = float(sys.argv[12])
  thdura   = int(sys.argv[13])
  thorog   = float(sys.argv[14])
  iz500    = int(sys.argv[15])
  xth      = float(sys.argv[16])
  #---
else:
  model       = "NorESM1-M"
