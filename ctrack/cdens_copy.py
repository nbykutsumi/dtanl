...
dens_area_name  = outdir + "/dens.area_%s_%s_%s_%s.bn"%(tstp, model, expr, ens)
track_name       = outdir + "/track.grid_%s_%s_%s_%s.bn"%(tstp, model, expr, ens)
#-----------
# write to file
#-----------
