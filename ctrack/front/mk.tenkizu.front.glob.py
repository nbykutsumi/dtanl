...
sodir         = sodir_root + "/%04d%02d/front.glob"%(year, mon)
...
soname     = sodir + "/front.glob.%s.%04d.%02d.%02d.%02d.M1-%04.2f.M2-%04.2f.png"%(vtype, year, mon, day, hour, thfmasktheta1, thfmasktheta2)
