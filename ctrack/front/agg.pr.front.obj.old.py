  ...
  for mon in lmon:
    ...
    for day in range(iday, eday+1):
      ...
      for hour in lhour:
        ...
        #************************************************
        # aggregate precip : overlap between bc and non-bc
        #-------------------------
        a2pr_olap_temp = ma.masked_where(a2terr_bcf ==miss, a2pr)
        a2pr_olap_temp = ma.masked_where(a2terr_nobc ==miss, a2pr_olap_temp)
