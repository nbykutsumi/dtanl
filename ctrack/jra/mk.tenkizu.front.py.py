  ...
  for mon in lmon:
    ...
    for day in range(iday, eday+1):
      for hour in lhour:
        ...
        tempfront1= frontdir + "/%02d/front.%s.%04d.%02d.%02d.%02d.M1-%3.2f.M2-%3.2f.png"%(day, vtype, year, mon, day, hour, thfmasktheta1, thfmasktheta2)
        os.rename(iname, tempfront1)
        ...
        subprocess.call(scmd, shell=True)
        iname     = frontdir + "/%02d/front.%s.%04d.%02d.%02d.%02d.png"%(day, vtype, year, mon, day, hour)
        tempfront2= frontdir + "/%02d/front.%s.%04d.%02d.%02d.%02d.M1-%3.2f.M2-%3.2f.png"%(day, vtype, year, mon, day, hour, thfmasktheta1, thfmasktheta2)
        os.rename(iname, tempfront2)
