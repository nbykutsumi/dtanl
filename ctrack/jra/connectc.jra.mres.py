...
for model in lmodel:
  ...
  #
  if model == "org":
    lastposdir_root  = "/media/disk2/out/JRA25/sa.one.anl_p/%s"%(tstp)
    pgmaxdir_root    = "/media/disk2/out/JRA25/sa.one.anl_p/%s"%(tstp)
    iposdir_root     = "/media/disk2/out/JRA25/sa.one.anl_p/%s"%(tstp)
    idatedir_root    = "/media/disk2/out/JRA25/sa.one.anl_p/%s"%(tstp)
    timedir_root     = "/media/disk2/out/JRA25/sa.one.anl_p/%s"%(tstp)
    lifedir_root     = "/media/disk2/out/JRA25/sa.one.anl_p/%s"%(tstp)
    nextposdir_root  = "/media/disk2/out/JRA25/sa.one.anl_p/%s"%(tstp)
  else:
    lastposdir_root  = "/media/disk2/out/JRA25/sa.one.%s/%s"%(model,tstp)
    pgmaxdir_root    = "/media/disk2/out/JRA25/sa.one.%s/%s"%(model,tstp)
    iposdir_root     = "/media/disk2/out/JRA25/sa.one.%s/%s"%(model,tstp)
    idatedir_root    = "/media/disk2/out/JRA25/sa.one.%s/%s"%(model,tstp)
    timedir_root     = "/media/disk2/out/JRA25/sa.one.%s/%s"%(model,tstp)
    lifedir_root     = "/media/disk2/out/JRA25/sa.one.%s/%s"%(model,tstp)
    nextposdir_root  = "/media/disk2/out/JRA25/sa.one.%s/%s"%(model,tstp)
