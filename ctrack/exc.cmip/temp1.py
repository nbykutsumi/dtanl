...
#idir = "/media/disk2/out/CMIP5/bn.sa.one.HadGEM2-ES.historical/6hr/exc/freq.48h/1980-1999.ALL"
...
if filterflag == "3x3":
  a2filter = a2filter3x3
elif filterflag == "5x5":
  a2filter = a2filter5x5
elif filterflag == "7x7":
  a2filter = a2filter7x7
elif filterflag == "21x21":
  a2filter = a2filter21x21
