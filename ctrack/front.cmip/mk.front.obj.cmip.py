...
for dtime, tnum in map(None, a1dtime, a1tnum):
  ...
  tname    = "/media/disk2/data/CMIP5/sa.one.%s.%s/ta/%04d%02d/ta.%04dhPa.r1i1p1.%04d%02d%02d%02d00.sa.one"%(model, expr ,year, mon, plev*0.01, year, mon, day, hour)
