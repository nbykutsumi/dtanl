...
a1latout   = arange(-89.95, 89.95, 0.5)
a1lonout   = arange(0.0, 359.95, 0.5)
...
for iy in range(0, ny):
  for ix in range(0, nx):
    if a2pgrad[iy, ix] >= thpgrad:
      ...
      print "iy_fin, ix_fin", iy_fin, ix_fin
      a2sum_temp, a2num_temp = ctrack_fsub.eqgrid_aggr(a2pr_fin.T, a1latout, a1lonout, dkm, nradkmgrid, iy_fin, ix_fin)
