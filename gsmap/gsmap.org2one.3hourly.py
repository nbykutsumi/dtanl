...
odir_root  = "/media/disk2/data/GSMaP/sa.one/3hr/ptot"
...
for year in range(iyear , eyear+1):
  for mon in range(imon, emon+1):
    ...
    for day in range(1, eday+1):
      #-----
      for hour0 in [0, 3, 6, 9, 12, 15, 18, 21]:
      #for hour0 in [0]:
        ...
        #-- write to file -----
        soname       = odir + "/gsmap_mvk.3rh.%04d%02d%02d.%02d00.v5.222.1.sa.one"%(year, mon, day, hour0)
