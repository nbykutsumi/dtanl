...
#***************************************
def ret_filedate_prday(var, dattype, model, expr, ens, iyear, imon, iday, ihour, imin, eyear, emon, eday, ehour, emin):
  #var    = "psl"
  #dattype= "6hrPlev"
  #model  = "MIROC5"
  #expr   = "historical"
  ...
  idir = "/home/utsumi/mnt/iis.data2/CMIP5/cmip5.day.pr"
