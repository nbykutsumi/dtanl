...
#lmodel=["HadGEM2-ES","IPSL-CM5A-MR","CNRM-CM5","inmcm4","NorESM1-M","IPSL-CM5B-LR","GFDL-CM3"]
lmodel=["CNRM-CM5"]
...
for expr, model, lev, var, year, mon in lloop:
  ...
  ##-- temp --
  #if (expr=="historical")&(lev==250)&(year<=1994):
  #  print "skip",expr,lev,var,year,mon
  #  continue
  #elif (expr=="historical")&(lev in [500,850]):
  #  print "skip",expr,lev,var,year,mon
  #  continue
  #elif (expr=="rcp85")&(lev==250)&(year<2092):
  #  print "skip",expr,lev,var,year,mon
  #  continue
  #elif (expr=="rcp85")&(lev in [500,850]):
  #  print "skip",expr,lev,var,year,mon
  #  continue
  ##----------
