...
for var in lvar:
  ...
  oname_withmiss = odir + "/chng.%s_%s_%s_%s_%06.2f.bn"%(var, tstp, model, ens, xth)
  oname_withnan  = odir + "/msked.chng.%s_%s_%s_%s_%06.2f.bn"%(var, tstp, model, ens, xth)
  frac_withmiss = odir + "/frac.chng.%s_%s_%s_%s_%06.2f.bn"%(var, tstp, model, ens, xth)
  frac_withnan  = odir + "/msked.frac.chng.%s_%s_%s_%s_%06.2f.bn"%(var, tstp, model, ens, xth)
  #-----
